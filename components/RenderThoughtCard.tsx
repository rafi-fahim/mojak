  ...
  const thoughts: ThoughtsTypes[] = [
    {
      ...
      qoute:
      "আমি সবসময় চেয়েছিলাম কবিতা পড়া যেন সহজ হয়ে উঠে। বর্তমান যুগে তরুন প্রজন্ম সোসাল মিডিয়ায় শুধু ঘুরে বেড়ানোর পোষ্ট দেয়। তারা যানেনা এমন সোশাল মিডিয়া তৈরি করা সম্ভম যেখানে তারা শুধু সৃজনশীল কাজ সেয়ার করতে পারবে। সেই বুদ্ধিকে কাজে রুপান্তর করার জন্যই আমার এরকম একটি অ্যাপ তৈরির ইচ্ছা ছিলো। টাই আমি আমার বন্ধু ফাহিম শাকিলের মাধ্যমে আমার এই সপ্নকে বাসবে রুপান্তর করি। ভবিষ্যতে কবিতা লেখা সবার জন্য উন্মুক্ত করা হবে। আপাতত হাতে ধরে কিছু ব্যাক্তি এখানে কবিতে লেখতে পারবেন। কিন্তু পড়তে পারবে সবাই।",
      index: 1,
    },
    {
      name: "Fahim Shakil",
