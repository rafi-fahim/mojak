  ...
  return (
    <div className="w-full h-auto text-center flex flex-col p-4 justify-center items-center">
      ...
      >
        ...
        {faliedLoginStatus && <p className="font-medium text-red-600">Wrong E-mail & Passowrd.. Try Again.... 😵</p>}
        <h2 className="self-start">Wanna be an <span className="font-medium text-theme-1">Admin</span></h2>
